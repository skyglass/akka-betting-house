...
case object BetKafkaProcessorSettings {
  def apply(configLocation: String, system: ActorSystem): BetKafkaProcessorSettings = {
...
final class BetKafkaProcessorSettings(val bootstrapServers: String, val topics: List[String], val groupId: String, val askTimeout: Timeout, val system: ActorSystem) {
